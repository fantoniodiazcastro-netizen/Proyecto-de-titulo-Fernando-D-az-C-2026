...
print("\n[SISTEMA] Iniciando ejecución del script.py...")
...
# =====================================================================
# 2. SUPERMATRIZ NO PONDERADA (TRANSCRIPCIÓN EXACTA)
# =====================================================================
raw = np.array([
#  OBJ1    C1EE    C2ET    C3EA    A1E  A2E  A3E  OBJ2    C1SE    C2ST    C3SA    A1S   A2S
[1.0000, 0.2534, 0.3335, 0.4131, 0.00, 0.00, 0.00, 0.0000, 0.0000, 0.0000, 0.0000, 0.00, 0.00], # OBJ1
[0.2534, 1.0000, 0.0000, 0.0000, 0.00, 0.00, 0.00, 0.0000, 0.0000, 0.0000, 0.0000, 0.33, 0.00], # C1EE
[0.3335, 0.0000, 1.0000, 0.0000, 0.00, 0.00, 0.00, 0.0000, 0.0000, 0.0000, 0.0000, 0.33, 0.00], # C2ET
[0.4131, 0.0000, 0.0000, 1.0000, 0.00, 0.00, 0.00, 0.0000, 0.0000, 0.0000, 0.0000, 0.33, 0.00], # C3EA

[0.0000, 0.7411, 1.0000, 0.14801, 1.00, 0.00, 0.00, 0.0000, 0.0000, 1.0000, 0.3300, 0.00, 0.00], # A1E
[0.0000, 0.13002, 0.0000, 0.19003, 0.00, 1.00, 0.00, 0.0000, 1.0000, 0.0000, 0.3300, 0.00, 0.00], # A2E
[0.0000, 0.1288, 0.0000, 0.66195, 0.00, 0.00, 1.00, 0.0000, 0.0000, 0.0000, 0.3300, 0.00, 0.00], # A3E

[0.0000, 0.0000, 0.0000, 0.0000, 0.00, 0.00, 0.00, 1.0000, 0.4421, 0.1837, 0.3741, 0.00, 0.00], # OBJ2
[0.0000, 0.0000, 0.0000, 0.0000, 0.00, 1.00, 0.33, 0.4421, 1.0000, 0.0000, 0.0000, 0.00, 0.00], # C1SE
[0.0000, 0.0000, 0.0000, 0.0000, 1.00, 0.00, 0.33, 0.1837, 0.0000, 1.0000, 0.0000, 0.00, 0.00], # C2ST
[0.0000, 0.0000, 0.0000, 0.0000, 0.00, 0.00, 0.33, 0.3741, 0.0000, 0.0000, 1.0000, 0.00, 0.00], # C3SA

[0.0000, 0.3300, 0.3300, 0.3300, 1.00, 1.00, 1.00, 0.0000, 0.8500, 0.6800, 1.0000, 1.00, 0.00], # A1S (VEE)
[0.0000, 0.0000, 0.0000, 0.0000, 0.00, 0.00, 0.00, 0.0000, 0.1500, 0.3100, 0.0000, 0.00, 1.00]  # A2S (VCI)
])
...
# =====================================================================
print("\n" + "="*90)
print(" S U P E R M A T R I Z   L Í M I T E   ( W ∞ )   )
print("="*90)
...
nombre_archivo = "Dashboard_Matriz_Nueva_VEE.png"
